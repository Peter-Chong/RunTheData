...
``` r
x <- data.frame("Checkpoint" = rep(c("5 km", "10 km", "15 km", "20 km", 
                                     "25 km", "30 km", "35 km", "40 km", "42 km"),2),
                "Diff" = c(mean(d5k[which(df$Gender == "Male")]), mean(d10k[which(df$Gender == "Male")]),
                           mean(d15k[which(df$Gender == "Male")]), mean(d20k[which(df$Gender == "Male")]),
                           mean(d25k[which(df$Gender == "Male")]), mean(d30k[which(df$Gender == "Male")]),
                           mean(d35k[which(df$Gender == "Male")]), mean(d40k[which(df$Gender == "Male")]),
                           mean(d42k[which(df$Gender == "Male")]), mean(d5k[which(df$Gender == "Female")]),
                           mean(d10k[which(df$Gender == "Female")]), mean(d15k[which(df$Gender == "Female")]),
                           mean(d20k[which(df$Gender == "Female")]), mean(d25k[which(df$Gender == "Female")]),
                           mean(d30k[which(df$Gender == "Female")]), mean(d35k[which(df$Gender == "Female")]),
                           mean(d40k[which(df$Gender == "Female")]), mean(d42k[which(df$Gender == "Female")])), 
...
ggplot(data=x, aes(x=Checkpoint, y=Diff, fill = Gender, color=Gender)) +
  ...
  scale_x_discrete(limits=c("5 km", "10 km", "15 km", "20 km", "25 km",
                            "30 km", "35 km", "40 km", "42 km")) + theme(legend.position = c(0.15, 0.8)) +
...
``` r
x1 <- data.frame("Leg" = rep(c("km 5-10", "km 10-15", "km 15-20", "km 20-25", 
                                     "km 25-30", "km 30-35", "km 35-40", "km 40-42"),2),
                "Diff" = c(mean(d5to10k[which(df$Gender == "Male")]), mean(d10to15k[which(df$Gender == "Male")]),
                           mean(d15to20k[which(df$Gender == "Male")]), mean(d20to25k[which(df$Gender == "Male")]),
                           mean(d25to30k[which(df$Gender == "Male")]), mean(d30to35k[which(df$Gender == "Male")]),
                           mean(d35to40k[which(df$Gender == "Male")]), mean(d40to42k[which(df$Gender == "Male")]),
                           mean(d5to10k[which(df$Gender == "Female")]), mean(d10to15k[which(df$Gender == "Female")]),
                           mean(d15to20k[which(df$Gender == "Female")]), mean(d20to25k[which(df$Gender == "Female")]),
                           mean(d25to30k[which(df$Gender == "Female")]), mean(d30to35k[which(df$Gender == "Female")]),
                           mean(d35to40k[which(df$Gender == "Female")]), mean(d40to42k[which(df$Gender == "Female")])),
...
ggplot(data=x1, aes(x=Leg, y=Diff, fill=Gender, color=Gender)) + ylab("Difference to 5k pace (%)") +
  ...
  scale_x_discrete(limits=c("km 5-10", "km 10-15", "km 15-20", "km 20-25",
                            "km 25-30", "km 30-35", "km 35-40", "km 40-42"))
```
...
```
    ...
    ## [1] "1 ~ 24"  "25 ~ 34" "35 ~ 44" "45 ~ 54" "55 ~ 64" "65 ~ 90"

``` r
x2 <- data.frame("Leg" = rep(c("km 5-10", "km 10-15", "km 15-20", "km 20-25", 
                                     "km 25-30", "km 30-35", "km 35-40", "km 40-42"),6),
                "Diff" = c(mean(d5to10k[which(df$AgeGroup == "1 ~ 24")]), 
                           mean(d10to15k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d15to20k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d20to25k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d25to30k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d30to35k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d35to40k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d40to42k[which(df$AgeGroup == "1 ~ 24")]),
                           mean(d5to10k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d10to15k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d15to20k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d20to25k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d25to30k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d30to35k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d35to40k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d40to42k[which(df$AgeGroup == "25 ~ 34")]),
                           mean(d5to10k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d10to15k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d15to20k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d20to25k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d25to30k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d30to35k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d35to40k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d40to42k[which(df$AgeGroup == "35 ~ 44")]),
                           mean(d5to10k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d10to15k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d15to20k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d20to25k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d25to30k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d30to35k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d35to40k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d40to42k[which(df$AgeGroup == "45 ~ 54")]),
                           mean(d5to10k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d10to15k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d15to20k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d20to25k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d25to30k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d30to35k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d35to40k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d40to42k[which(df$AgeGroup == "55 ~ 64")]),
                           mean(d5to10k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d10to15k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d15to20k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d20to25k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d25to30k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d30to35k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d35to40k[which(df$AgeGroup == "65 ~ 90")]),
                           mean(d40to42k[which(df$AgeGroup == "65 ~ 90")])),
