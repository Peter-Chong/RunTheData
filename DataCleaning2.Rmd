...
Next, I would like to measure the speed difference in the first 5km and the rest of the legs. However, I notice that the data does not make sense for the 5km pace. Let's look at the 10 fastest 5km time.

```{r}
head(sort(df$X5ks, decreasing = FALSE), 10)/60
```

Please note that the world record for 5km is 12 minute. If the data is accurate, it means that all these 10 runners are the new world record holders. Since the data collection is wrong, I will measure the speed difference between the fifth km to the 10th km and the rest of the legs. I will explain more about this column in the EDA and model building.
